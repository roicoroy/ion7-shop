...
export class AddressDetailsPage implements OnInit, OnDestroy {
  ...
  saveEditedAddress() {
    ...
    const address: IRegisterAddress = {
      ...
      address_1: this.adressDetailsForm.get('address_1').value,
      address_2: this.adressDetailsForm.get('address_2').value,
      region_code: this.adressDetailsForm.get('region_code').value,
      country_code: this.adressDetailsForm.get('country').value,
      city: this.adressDetailsForm.get('city').value,
      postal_code: this.adressDetailsForm.get('postal_code').value,
      phone: this.adressDetailsForm.get('phone').value,
    };
    if (this.adressDetailsForm.valid) {
      this.store.dispatch(new CustomerActions.UpdateCustomerAddress(this.adressDetailsForm.get('id').value, address));
